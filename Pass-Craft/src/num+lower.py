...
default_filename = "sukh_num+lower.txt"
default_path = ""

# Password generation and save (numbers + lowercase letters)
passwords = [''.join(x) for x in itertools.product('0123456789abcdefghijklmnopqrstuvwxyz', repeat=password_length)]
...
# Loading bar
total_combinations = (10 + 26) ** password_length
