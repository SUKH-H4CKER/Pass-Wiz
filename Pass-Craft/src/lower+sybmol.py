...
default_filename = "sukh_lower+symbol.txt"
default_path = ""

# Special symbols for generating passwords
special_symbols = "!@#$%^&*()_+[]{}|;':,.<>?/\\"

# Password generation and save (lowercase letters + special symbols)
passwords = [''.join(x) for x in itertools.product('abcdefghijklmnopqrstuvwxyz' + special_symbols, repeat=password_length)]
...
# Loading bar
total_combinations = (26 + len(special_symbols)) ** password_length
