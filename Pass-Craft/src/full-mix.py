...
default_filename = "sukh_mix.txt"
default_path = ""

# Special symbols for generating passwords
special_symbols = "!@#$%^&*()_+[]{}|;':,.<>?/\\"

# Password generation and save (uppercase letters + lowercase letters + numbers + special symbols)
passwords = [''.join(x) for x in itertools.product('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789' + special_symbols, repeat=password_length)]
...
# Loading bar
total_combinations = (26 + 26 + 10 + len(special_symbols)) ** password_length
...
print("\033[32mPassword List Generated Successfully!\033[0m")
