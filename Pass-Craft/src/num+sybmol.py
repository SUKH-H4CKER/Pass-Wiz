...
default_filename = "sukh_num+sybmol.txt"
default_path = ""

# Special symbols for generating passwords
special_symbols = "!@#$%^&*()_+[]{}|;':,.<>?/\\"

# Password generation and save (numbers + special symbols)
passwords = [''.join(x) for x in itertools.product('0123456789' + special_symbols, repeat=password_length)]
...
# Loading bar
total_combinations = (10 + len(special_symbols)) ** password_length
