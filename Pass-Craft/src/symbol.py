...
default_filename = "sukh_symbol.txt"
default_path = ""

# Special symbols for generating passwords
special_symbols = "!@#$%^&*()_+[]{}|;':,.<>?/\\"

# Password generation and save (only special symbols)
passwords = [''.join(x) for x in itertools.product(special_symbols, repeat=password_length)]
...
# Loading bar
total_combinations = len(special_symbols) ** password_length
...
input("\033[36mPeess Enter to Continue!\n")
